 ...
 *   https://datatables.net/download/#bs/dt-1.10.10,fh-3.1.0
 *
 * Included libraries:
...
oPaginate:{sFirst:"ראשון",sLast:"אחרון",sNext:"הבא",sPrevious:"הקודם"},sEmptyTable:"אין מידע בטבלה",sInfo:"מראה _START_ עד _END_ מתוך _TOTAL_ תוצאות",sInfoEmpty:"מראה 0 עד 0 מתוך 0 תוצאות",sInfoFiltered:"(סונן מתוך _MAX_ תוצאות)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"מראה _MENU_ תוצאות",sLoadingRecords:"טוען...",sProcessing:"מעבד...",sSearch:"חיפוש:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"לא נמצאו תוצאות"},oSearch:h.extend({},
