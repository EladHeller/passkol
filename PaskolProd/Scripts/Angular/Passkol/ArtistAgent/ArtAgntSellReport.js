angular.module('passkolApp')
    .controller('ArtAgntSellReport', ['$scope', 'purchaseService', function ($scope, purchaseService) {
        ...
        $scope.getReports = function () {
            ...
            purchaseService.getArtistAgntReports(req, $scope.antiForgeryToken).then(function (res) {
